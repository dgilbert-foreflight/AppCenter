...
extension API.Apps.WithOwnerName.WithAppName.User {
  ...
  public struct DeviceSets {
    ...
    public var get: Request<[GetResponseItem]> {
      Request(method: "GET", url: path, id: "test_listDeviceSetsOfUser")
    }
    ...
    public func post(_ body: PostRequest) -> Request<PostResponse> {
      Request(method: "POST", url: path, body: body, id: "test_createDeviceSetOfUser")
    }
