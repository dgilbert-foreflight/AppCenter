...
extension API.Apps.WithOwnerName.WithAppName.DistributionStores.WithStoreName.Releases {
  ...
  public struct WithReleaseID {
    ...
    public var get: Request<[GetResponseItem]> {
      Request(method: "GET", url: path, id: "storeReleases_get")
    }
    ...
    public func delete(_ body: String? = nil) -> Request<Void> {
      Request(method: "DELETE", url: path, body: body, id: "storeReleases_delete")
    }
  }
}
