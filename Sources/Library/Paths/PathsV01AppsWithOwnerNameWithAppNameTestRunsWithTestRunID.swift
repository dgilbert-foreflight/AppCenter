...
extension API.Apps.WithOwnerName.WithAppName.TestRuns {
  ...
  public struct WithTestRunID {
    ...
    public var get: Request<GetResponse> {
      Request(method: "GET", url: path, id: "test_getTestRun")
    }
    ...
    public var delete: Request<DeleteResponse> {
      Request(method: "DELETE", url: path, id: "test_archiveTestRun")
    }

    /// Test Run
    ///
    /// Summary single test run on Xamarin Test Cloud
    public struct DeleteResponse: Decodable, Identifiable {
      /// The unique id of the test upload
      public var id: UUID?
      /// The date and time the test was uploaded
      public var date: String?
