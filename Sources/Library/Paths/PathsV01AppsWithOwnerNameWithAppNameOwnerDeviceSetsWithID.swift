...
extension API.Apps.WithOwnerName.WithAppName.Owner.DeviceSets {
  ...
  public struct WithID {
    ...
    public var get: Request<GetResponse> {
      Request(method: "GET", url: path, id: "test_getDeviceSetOfOwner")
    }
    ...
    public func put(_ body: PutRequest) -> Request<PutResponse> {
      Request(method: "PUT", url: path, body: body, id: "test_updateDeviceSetOfOwner")
    }
    ...
    public var delete: Request<Void> {
      Request(method: "DELETE", url: path, id: "test_deleteDeviceSetOfOwner")
    }
  }
}
