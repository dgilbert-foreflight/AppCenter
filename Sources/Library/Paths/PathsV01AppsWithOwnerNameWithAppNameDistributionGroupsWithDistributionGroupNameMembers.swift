...
extension API.Apps.WithOwnerName.WithAppName.DistributionGroups.WithDistributionGroupName {
  ...
  public struct Members {
    ...
    public func get(excludePendingInvitations: Bool? = nil) -> Request<[GetResponseItem]> {
      Request(method: "GET", url: path, query: makeGetQuery(excludePendingInvitations), id: "distributionGroups_listUsers")
    }
    ...
    public func post(userEmails: [String]? = nil) -> Request<[PostResponseItem]> {
      Request(method: "POST", url: path, body: ["user_emails": userEmails], id: "distributionGroups_addUser")
    }
