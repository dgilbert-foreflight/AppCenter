...
extension API.Apps.WithOwnerName.WithAppName.Errors {
  ...
  public struct ErrorGroups {
    ...
    public func get(parameters: GetParameters) -> Request<GetResponse> {
      Request(method: "GET", url: path, query: parameters.asQuery, id: "Errors_GroupList")
    }
    ...
    public struct GetParameters {
      ...
      public init(version: String? = nil, appBuild: String? = nil, groupState: String? = nil, start: Date, end: Date? = nil, orderby: String? = nil, top: Int64? = nil, errorType: ErrorType? = nil) {
