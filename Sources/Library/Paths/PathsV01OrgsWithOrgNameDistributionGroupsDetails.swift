...
extension API.Orgs.WithOrgName {
  ...
  public struct DistributionGroupsDetails {
    ...
    public func get(appsLimit: Double? = nil) -> Request<[GetResponseItem]> {
      Request(method: "GET", url: path, query: makeGetQuery(appsLimit), id: "distributionGroups_detailsForOrg")
    }
    ...
    public struct GetResponseItem: Decodable, Identifiable {
      ...
      public init(id: UUID, name: String, displayName: String? = nil, origin: Origin, isPublic: Bool, totalAppsCount: Double? = nil, totalUsersCount: Double? = nil, apps: [App]? = nil) {
        self.id = id
        self.name = name
        self.displayName = displayName
        self.origin = origin
