...
extension API.Apps.WithOwnerName.WithAppName.User.DeviceSets {
  ...
  public struct WithID {
    ...
    public var get: Request<GetResponse> {
      Request(method: "GET", url: path, id: "test_getDeviceSetOfUser")
    }
    ...
    public func put(_ body: PutRequest) -> Request<PutResponse> {
      Request(method: "PUT", url: path, body: body, id: "test_updateDeviceSetOfUser")
    }
    ...
    public var delete: Request<Void> {
      Request(method: "DELETE", url: path, id: "test_deleteDeviceSetOfUser")
    }
  }
}
