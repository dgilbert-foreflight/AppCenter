...
extension API.Apps.WithOwnerName.WithAppName {
  ...
  public struct AzureSubscriptions {
    ...
    public var get: Request<[GetResponseItem]> {
      Request(method: "GET", url: path, id: "azureSubscription_listForApp")
    }
    ...
    public func post(subscriptionID: UUID) -> Request<Void> {
      Request(method: "POST", url: path, body: ["subscription_id": subscriptionID], id: "azureSubscription_linkForApp")
    }
  }
}
