...
extension API.Apps.WithOwnerName.WithAppName.Errors.WithErrorID {
  ...
  public struct SessionLogs {
    ...
    public func get(date: Date? = nil) -> Request<GetResponse> {
      Request(method: "GET", url: path, query: makeGetQuery(date), id: "Errors_ListSessionLogs")
    }
    ...
    public struct GetResponse: Decodable {
      ...
      public struct Log: Decodable {
        ...
        public init(type: `Type`, timestamp: Date, installID: UUID, sessionID: UUID? = nil, eventID: String? = nil, eventName: String? = nil, messageID: String? = nil, properties: [String: String]? = nil, device: Device) {
          self.type = type
