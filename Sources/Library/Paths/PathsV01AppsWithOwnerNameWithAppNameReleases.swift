...
extension API.Apps.WithOwnerName.WithAppName {
  ...
  public struct Releases {
    ...
    public func get(parameters: GetParameters? = nil) -> Request<[GetResponseItem]> {
      Request(method: "GET", url: path, query: parameters?.asQuery, id: "releases_list")
    }
    ...
    public struct GetParameters {
      public var isPublishedOnly: Bool?
      public var scope: String?
      public var top: Double?
      public var releaseID: Double?

      public init(isPublishedOnly: Bool? = nil, scope: String? = nil, top: Double? = nil, releaseID: Double? = nil) {
        self.isPublishedOnly = isPublishedOnly
        self.scope = scope
        self.top = top
      ...
      public var asQuery: [(String, String?)] {
        ...
        encoder.encode(releaseID, forKey: "releaseId")
