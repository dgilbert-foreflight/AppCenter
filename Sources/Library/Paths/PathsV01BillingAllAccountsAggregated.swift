...
extension API.Billing {
  ...
  public struct AllAccountsAggregated {
    ...
    public func get(parameters: GetParameters? = nil) -> Request<GetResponse> {
      Request(method: "GET", url: path, query: parameters?.asQuery, id: "billingAggregatedInformation_getAll")
    }
    ...
    public struct GetResponse: Decodable {
      ...
      /// Aggregated Billing Information for a user or an organization
      public struct AggregatedBillings: Decodable, Identifiable {
      ...
      public init(from decoder: Decoder) throws {
        let values = try decoder.container(keyedBy: StringCodingKey.self)
        self.aggregatedBillings = try values.decodeIfPresent(AggregatedBillings.self, forKey: "aggregatedBillings")
      }
    }
