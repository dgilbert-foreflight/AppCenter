...
extension API.Invitations {
  ...
  public struct Sent {
    ...
    public var get: Request<[GetResponseItem]> {
      Request(method: "GET", url: path, id: "invitations_sent")
    }
    ...
    public struct GetResponseItem: Decodable {
      ...
      public struct Organization: Decodable, Identifiable {
      ...
      public init(invitationID: UUID, organization: Organization? = nil, app: App? = nil) {
