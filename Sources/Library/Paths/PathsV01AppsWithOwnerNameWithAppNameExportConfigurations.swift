...
extension API.Apps.WithOwnerName.WithAppName {
  ...
  public struct ExportConfigurations {
    ...
    public var get: Request<GetResponse> {
      Request(method: "GET", url: path, id: "ExportConfigurations_List")
    }
    ...
    public struct GetResponse: Decodable {
      ...
      public struct Value: Decodable, Identifiable {
    ...
    public func post(_ body: PostRequest) -> Request<PostResponse> {
      Request(method: "POST", url: path, body: body, id: "ExportConfigurations_Create")
    }
