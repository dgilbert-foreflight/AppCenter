...
public struct AppInvitationDetailResponse: Codable, Identifiable {
  ...
  public init(id: UUID, app: App, email: String, inviteType: InviteType, invitedBy: InvitedBy, isExistingUser: Bool, permissions: [Permission]? = nil, appCount: Double? = nil, distributionGroup: DistributionGroup? = nil) {
    self.id = id
    self.app = app
    self.email = email
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.email = try values.decode(String.self, forKey: "email")
    self.inviteType = try values.decode(InviteType.self, forKey: "invite_type")
    ...
    self.permissions = try values.decodeIfPresent([Permission].self, forKey: "permissions")
    self.appCount = try values.decodeIfPresent(Double.self, forKey: "app_count")
    self.distributionGroup = try values.decodeIfPresent(DistributionGroup.self, forKey: "distribution_group")
  }
