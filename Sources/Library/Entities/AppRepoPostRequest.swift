...
public struct AppRepoPostRequest: Codable {
  ...
  public init(repoURL: String, repoProvider: RepoProvider? = nil, userID: UUID, installationID: String? = nil, repoID: String? = nil, externalUserID: String? = nil, serviceConnectionID: UUID? = nil) {
