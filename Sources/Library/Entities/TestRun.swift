...
public struct TestRun: Codable, Identifiable {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try values.encodeIfPresent(testSeries, forKey: "testSeries")
    try values.encodeIfPresent(platform, forKey: "platform")
    try values.encodeIfPresent(runStatus, forKey: "runStatus")
    try values.encodeIfPresent(resultStatus, forKey: "resultStatus")
    try values.encodeIfPresent(state, forKey: "state")
    try values.encodeIfPresent(status, forKey: "status")
    try values.encodeIfPresent(description, forKey: "description")
    try values.encodeIfPresent(stats, forKey: "stats")
    try values.encodeIfPresent(testType, forKey: "testType")
  }
}
