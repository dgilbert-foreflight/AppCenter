...
public struct UserProfileAdminResponse: Codable, Identifiable {
  ...
  public init(id: UUID, avatarURL: String? = nil, canChangePassword: Bool? = nil, displayName: String, email: String, name: String, permissions: [Permission]? = nil, origin: Origin, role: Role? = nil) {
    self.id = id
