...
public struct CloseAccountOrganizationResponse: Codable, Identifiable {
  ...
  public init(id: UUID, displayName: String, name: String, avatarURL: String? = nil, origin: Origin, createdAt: String, updatedAt: String, collaboratorsCount: Double? = nil) {
    self.id = id
